  ...
  return (
    <main css={container}>
      <div css={contentContainer}>
        <section css={title}>
          <div>Mocco 개인정보 처리 방침</div>
        </section>
        <section>
          <div>
            <div css={policyBold}>
              (Mocco) (`https://mocco.kr` 이하 `Mocco`) 은(는) 「개인정보
              보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한
              고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이
              개인정보 처리방침을 수립·공개합니다.
              <br />
              <br /> 이 개인정보처리방침은 2022년 10월 12일 부터 적용됩니다.
            </div>
            <div css={policyBold}>제1조(개인정보의 처리 목적)</div>
            <br />
            <p>
              (Mocco) (`https://urlurl` 이하 `Mocco`)은(는) 다음의 목적을 위하여
              개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의
              용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보
              보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할
              예정입니다.
              <br /> <br />
              1. 재화 또는 서비스 제공 <br /> <br />
              서비스 제공을 목적으로 개인정보를 처리합니다.
              <br />
            </p>
            <div css={policyBold}>제2조(개인정보의 처리 및 보유 기간)</div>
            <p>
              <br />① (Mocco)은(는) 법령에 따른 개인정보 보유·이용기간 또는
              정보주체로부터 개인정보를 수집 시에 동의받은 개인정보
              보유·이용기간 내에서 개인정보를 처리·보유합니다. <br />② 각각의
              개인정보 처리 및 보유 기간은 다음과 같습니다. <br />
              <br />
              1.(재화 또는 서비스 제공) (재화 또는 서비스 제공)와 관련한
              개인정보는 수집.이용에 관한 동의일로부터(지체없이 파기)까지 위
              이용목적을 위하여 보유.이용됩니다.
            </p>
            <div css={policyBold}>제3조(처리하는 개인정보의 항목) </div>
            <br />
            <p>
              ①(Mocco)은(는) 다음의 개인정보 항목을 처리하고 있습니다. <br />
              <br />
              1( 재화 또는 서비스 제공 ) 필수항목 : 서비스 이용 기록 <br />
            </p>
            <div css={policyBold}>제4조(개인정보의 파기절차 및 파기방법)</div>
            <p>
              <br />① (Mocco)은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
              개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를
              파기합니다. <br />② 정보주체로부터 동의받은 개인정보 보유기간이
              ...
              <br />③ 개인정보 파기의 절차 및 방법은 다음과 같습니다. <br />
              <br />
              1. 파기절차 (Mocco) 은(는) 파기 사유가 발생한 개인정보를 선정하고,
              (Mocco) 의 개인정보 보호책임자의 승인을 받아 개인정보를
              파기합니다.
              <br />
            ...
            <p>
              <br />① 정보주체는 mocco에 대해 언제든지 개인정보
              열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
              <br /> ② 제1항에 따른 권리 행사는mocco에 대해 「개인정보 보호법」
              시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
              통하여 하실 수 있으며 mocco은(는) 이에 대해 지체 없이
              조치하겠습니다. <br />③ 제1항에 따른 권리 행사는 정보주체의
              ...
              <br />⑥ mocco은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
            ...
            <br />
            <p>
              (Mocco)은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
              취하고 있습니다. <br />
              <br />
              1. 개인정보에 대한 접근 제한 개인정보를 처리하는
            ...
            <p>
              <br /> mocco 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
              ‘쿠키(cookie)’를 사용하지 않습니다.
            </p>
            <div css={policyBold}>제8조 (개인정보 보호책임자에 관한 사항)</div>
            <p>
              <br /> ① mocco 은(는) 개인정보 처리에 관한 업무를 총괄해서
              ...
              직책 :일반 <br />
              직급 :일반 <br />
              연락처 :123-4567-8910, mocco@mocco.com, <br />
              ...
              담당자 : 김모코
              <br />
              연락처 :123-4567-8910, mocco@mocco.com <br /> ② 정보주체께서는
              mocco 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보
              보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
              보호책임자 및 담당부서로 문의하실 수 있습니다. ,mocco 은(는)
            ...
            <p>
              ...
              아래의 부서에 할 수 있습니다. (Mocco) 은(는) 정보주체의 개인정보
              열람청구가 신속하게 처리되도록 노력하겠습니다. <br />▶ 개인정보
              열람청구 접수·처리 부서
              <br />
              <br /> 부서명 : mocco
              <br /> 담당자 : 김모코
              <br />
              연락처 :123-4567-8910, mocco@mocco.com
            </p>
            <div css={policyBold}>
            ...
            <p>
              ...
              바랍니다. <br /> 개인정보분쟁조정위원회 : (국번없이) 1833-6972
              (www.kopico.go.kr)
            ...
            <div css={policyBold}>제11조(개인정보 처리방침 변경)</div>
            <p>
              <br /> ① 이 개인정보처리방침은 2022년 10월 12일부터 적용됩니다.
            </p>
          </div>
        </section>
      </div>
